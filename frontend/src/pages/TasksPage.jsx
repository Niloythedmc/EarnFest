          ...
          <>
            {user?.isJoined === false && (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <h4 style={{ margin: '0 0 4px 0', fontSize: '0.85rem', fontWeight: 'bold', color: '#f87171' }}>
                    Warning: Join Channels
                  </h4>
                  <p style={{ margin: 0, fontSize: '0.75rem', lineHeight: '1.4', color: '#fca5a5' }}>
                    Your rewards will not be credited if you are not joined in our channel and group.
                  </p>
                </div>
              </motion.div>
            )}
