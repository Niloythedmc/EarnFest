...
const TIPS = [
  ...
  { type: '🎮 Tip', text: 'Play Coin Flip and Slots to multiply your $FEST earnings.' },
  ...
  { type: '🎲 Trick', text: 'In Coin Flip, start with small bets to learn the pattern before going big.' },
